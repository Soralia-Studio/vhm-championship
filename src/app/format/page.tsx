        ...
        <>
            <div className='min-h-screen flex flex-col pt-[95px] sm:pt-[111px] pb-8 px-4 sm:px-8'>
                <div className='w-full max-w-4xl mx-auto flex flex-col gap-6'>
                    {/* Timeline box */}
                    <div
                        className='rounded-2xl px-6 sm:px-10 py-8 flex flex-col gap-0'
                    ...
                    {/* Text content box */}
                    <div
                        className='rounded-2xl px-6 sm:px-10 py-8 flex flex-col gap-8'
                        style={{
                    ...
                    >
                        <section>
                            ...
                            <p className='text-white/80 text-sm sm:text-base leading-relaxed mb-4'>
                                VHM Championship — Soralia CAFE là giải đấu Arknights thường niên được tổ chức bởi cộng
                                đồng VHM, với sự hợp tác của DreamGames, Soralia CAFE và Arknights VNS. Giải đấu hướng
                                đến việc tạo ra một sân chơi công bằng, lành mạnh và chuyên nghiệp cho tất cả người chơi
                                tại Việt Nam.
                            </p>
                            <p className='text-white/80 text-sm sm:text-base leading-relaxed mb-4'>
                                Mùa giải lần này quy tụ các đội tuyển mạnh nhất từ khắp cả nước, thi đấu trong nhiều
                                vòng kịch tính để tranh giành danh hiệu cao nhất. Mỗi trận đấu đều được phát sóng trực
                                tiếp và bình luận bởi các caster hàng đầu cộng đồng.
                            </p>
                        ...
                        <section>
                            ...
                            <ul className='text-white/80 text-sm sm:text-base leading-relaxed list-disc list-inside flex flex-col gap-2'>
                                ...
                                <li>
                                    Tài khoản thi đấu phải là tài khoản chính, không được dùng tài khoản mượn hoặc
                                    share.
                                </li>
                                <li>
                                    Không được sử dụng bất kỳ công cụ hỗ trợ, macro hay bot trong quá trình thi đấu.
                                </li>
                                <li>
                                    Kết quả ghi hình từ phía ban tổ chức là căn cứ phán quyết cuối cùng trong mọi tranh
                                    chấp.
                                </li>
                                <li>
                                    Các đội phải có mặt online và sẵn sàng đúng giờ. Trễ quá 10 phút sẽ bị xử thua ván
                                    đó.
                                </li>
                                <li>
                                    Mọi hành vi toxic, hate speech hay phân biệt đối xử đều bị xử lý nghiêm theo quy
                                    định của ban tổ chức.
                                </li>
                                <li>
                                    Quyết định của ban tổ chức là quyết định cuối cùng và không có kháng cáo sau 24 giờ.
                                </li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <div className='flex flex-col gap-4 text-white/80 text-sm sm:text-base leading-relaxed'>
                                <div>
                                    ...
                                    <p>
                                        Các đội thi đấu theo thể thức round-robin trong bảng. Hai đội đứng đầu mỗi bảng
                                        sẽ tiến vào vòng loại trực tiếp. Kết quả được tính theo điểm số, sau đó là hiệu
                                        số ván thắng/thua.
                                    </p>
                                </div>
                                <div>
                                    ...
                                    <p>
                                        Tám đội tiếp tục thi đấu theo thể thức loại trực tiếp Bo3. Đội nào thắng 2 ván
                                        trước tiến tiếp vào bán kết.
                                    </p>
                                </div>
                                <div>
                                    <h3 className='text-white font-semibold mb-1'>Bán Kết & Chung Kết</h3>
                                    <p>
                                        Bán kết và Chung kết sử dụng thể thức Bo5. Chung kết diễn ra trực tiếp có khán
                                        giả tham dự và caster bình luận live.
                                    </p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <p className='text-white/80 text-sm sm:text-base leading-relaxed mb-4'>
                                Ban tổ chức có quyền thay đổi lịch thi đấu trong trường hợp bất khả kháng như sự cố máy
                                chủ hoặc thảm họa thiên nhiên. Mọi thay đổi sẽ được thông báo qua kênh Discord chính
                                thức ít nhất 2 giờ trước khi trận đấu bắt đầu.
                            </p>
                            <p className='text-white/80 text-sm sm:text-base leading-relaxed mb-4'>
                                Các đội đăng ký tham dự đồng ý cho phép ban tổ chức sử dụng hình ảnh, video và tên đội
                                trong các tài liệu truyền thông liên quan đến giải đấu mà không cần thêm sự đồng ý.
                            </p>
                            <p className='text-white/80 text-sm sm:text-base leading-relaxed mb-4'>
                                Trong trường hợp kết quả bảng đấu bằng điểm, tiebreaker sẽ được áp dụng theo thứ tự: (1)
                                Head-to-head, (2) Hiệu số ván, (3) Tổng damage trong ván quyết định.
                            </p>
                            <p className='text-white/80 text-sm sm:text-base leading-relaxed'>
                                Mọi thắc mắc và khiếu nại phải được gửi qua form chính thức trong vòng 24 giờ sau khi
                                kết quả được công bố. Sau thời hạn này, mọi khiếu nại sẽ không được xem xét.
                            </p>
                        </section>
                    </div>
                </div>
